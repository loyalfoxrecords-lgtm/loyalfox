...
export default function Catalog() {
  ...
  const filtered = active === "all"
    ? tracks
    : tracks.filter(tr => tr.genre?.toLowerCase() === active);
      ...
      <div style={{ margin:"80px 56px 0",
        ...
        <div style={{ display:"flex", alignItems:"center", gap:"24px" }}>
          <div style={{ display:"flex", alignItems:"flex-end",
            gap:"3px", height:"28px", flexShrink:0 }}>
            {[6,16,28,11,22,8,18,24].map((h,i) => (
              <span key={i} style={{ display:"block", width:"3px",
                borderRadius:"2px", height:`${h}px`, background:"#a8e63d",
        ...
        <a href="https://open.spotify.com" target="_blank" rel="noreferrer"
          style={{ display:"inline-flex", alignItems:"center", gap:"10px",
            ...
            letterSpacing:"2px", textTransform:"uppercase",
            padding:"16px 32px", background:"#1DB954",
            color:"#000", fontWeight:700, transition:"all .3s" }}
