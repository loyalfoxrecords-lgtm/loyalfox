    ...
    <section id="about" style={{ background:"var(--black)" }}>
        ...
        <div style={{ position:"absolute", bottom:"20px", left:"20px" }}>
          ...
          <h2 style={{ fontFamily:"var(--font-display)",
            ...
            <span style={{ color:"transparent",
              WebkitTextStroke:"1.5px rgba(240,240,240,0.15)" }}>FRONTERAS</span>
          </h2>
        </div>
      </div>
      ...
      <div style={{ padding:"40px 20px" }}>
        <p style={{ fontFamily:"var(--font-mono)", fontSize:"12px",
          ...
          LoyalFox Records nació en 2025 en España con una visión clara: construir el sello independiente con mayor número de oyentes de música electrónica en Europa.
        </p>
        <p style={{ fontFamily:"var(--font-mono)", fontSize:"12px",
          lineHeight:2, color:"rgba(240,240,240,0.35)", marginBottom:"32px" }}>
          No somos solo un sello de distribución. Somos una comunidad de artistas, streamers y creadores que comparten una misma filosofía.
        </p>
        ...
        <motion.div style={{ position:"absolute", inset:0, display:"flex",
          ...
          <div>
            ...
            <h2 style={{ fontFamily:"var(--font-display)",
              ...
              MÚSICA SIN<br />
              <span style={{ color:"transparent",
                WebkitTextStroke:"2px rgba(240,240,240,0.15)" }}>FRONTERAS</span>
            </h2>
          </div>
        </motion.div>
      </div>
