...
export default function About() {
  ...
  const values = [
    { n:"01", title:"Comunidad",     desc:"Un sello construido sobre relaciones reales entre artistas, oyentes y creadores de contenido." },
    { n:"02", title:"Calidad",       desc:"Cada release pasa por un proceso de selección riguroso. Solo publicamos lo que nos mueve de verdad." },
    { n:"03", title:"Distribución",  desc:"Presencia en todas las plataformas principales. Tu música donde está tu audiencia." },
    { n:"04", title:"Transparencia", desc:"Regalías claras, pagos puntuales y acceso total a tus datos desde tu panel de artista." },
  ];

  return (
    <section ref={ref} id="about" style={{ background:"var(--black)",
      position:"relative", overflow:"hidden" }}>

      {/* Hero visual — foto grande */}
      <div style={{ position:"relative", height:"70vh", overflow:"hidden" }}>
        ...
        <motion.div style={{ position:"absolute", inset:0,
          ...
          padding:"56px 56px 64px", y: textY, opacity: textO }}>
          <div>
      ...
      <div style={{ padding:"100px 56px",
        ...
        <motion.div
          ...
          <p style={{ fontFamily:"var(--font-mono)", fontSize:"13px",
            ...
            LoyalFox Records nació en 2025 en España con una visión clara: construir el sello
            independiente con mayor número de oyentes de música electrónica en Europa.
          </p>
          <p style={{ fontFamily:"var(--font-mono)", fontSize:"13px",
            lineHeight:2, color:"rgba(240,240,240,0.35)" }}>
            No somos solo un sello de distribución. Somos una comunidad de artistas,
            streamers y creadores que comparten una misma filosofía: la música electrónica
            como forma de conexión real.
          </p>

          {/* Stats reales */}
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr",
            gap:"2px", marginTop:"56px" }}>
            {[
              { n: String(stats.tracks),   l:"Tracks publicados"   },
              { n: fmtN(stats.streams),    l:"Reproducciones"      },
              { n: String(stats.artists),  l:"Artistas activos"    },
              ...
              <div key={i} style={{ padding:"28px 24px",
                ...
                <p style={{ fontFamily:"var(--font-display)", fontSize:"44px",
                  lineHeight:1, color:"#a8e63d", marginBottom:"6px" }}>
                  {s.n}
                </p>
          ...
          {values.map((v, i) => (
            <motion.div key={v.n}
              ...
              <span style={{ fontFamily:"var(--font-display)", fontSize:"32px",
                color:"rgba(168,230,61,0.2)", lineHeight:1 }}>
                {v.n}
              </span>
              <div>
                ...
                <p style={{ fontFamily:"var(--font-mono)", fontSize:"11px",
                  lineHeight:1.8, color:"rgba(240,240,240,0.35)" }}>
                  {v.desc}
                </p>
              </div>
            </motion.div>
