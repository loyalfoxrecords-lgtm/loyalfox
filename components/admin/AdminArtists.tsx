...
export default function AdminArtists() {
  ...
  const ArtistForm = ({ data, onChange, onUpload }: {
    data: typeof empty;
    ...
    <div style={{ maxWidth:"1000px" }}>
      ...
      <div style={{ ...hs.section, marginBottom:"24px" }}>
        ...
        <div style={{ padding:"20px" }}>
          <ArtistForm data={form} onChange={setForm}
                ...
                <tr key={artist.id} style={{ borderBottom:`1px solid ${css.border}`,
                  ...
                  <td style={{ padding:"10px 16px" }}>
                    <p style={{ fontSize:"13px", fontWeight:500,
                      color:css.text, fontFamily:"system-ui" }}>{artist.name}</p>
                    <p style={{ fontSize:"11px", color:css.textMute,
                      fontFamily:"system-ui" }}>/artists/{artist.slug}</p>
                  </td>
                  <td style={{ padding:"10px 16px" }}>
