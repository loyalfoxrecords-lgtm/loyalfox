          ...
          <div style={{ display:"flex", alignItems:"center", gap:"8px" }}>
            ...
            <div>
              <p style={{ fontSize:"13px", fontWeight:600,
                color:css.text, lineHeight:1 }}>LoyalFox</p>
      ...
      <div style={{ flex:1, overflow:"auto" }}>
        ...
        <div style={{ padding:"16px 32px", borderBottom:`1px solid ${css.border}`,
          ...
          {summary.readyToPay.length > 0 && (
            <div
              onClick={() => setActive("artist-accounts")}
              style={{ display:"flex", alignItems:"center", gap:"6px",
                padding:"6px 12px", borderRadius:"6px", cursor:"pointer",
                background:css.greenBg, border:`1px solid ${css.greenBorder}` }}>
            ...
            <div style={{ maxWidth:"1200px" }}>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)",
                ...
                {[
                  ...
                  <div key={i} style={{ background:css.white,
                    ...
                    <p style={{ fontSize:"22px", fontWeight:700,
                      color:css.text, marginBottom:"2px" }}>{k.value}</p>
                    <p style={{ fontSize:"11px", color:css.textMute }}>{k.sub}</p>
                  </div>
                ))}
              </div>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"16px" }}>
                ...
                <div style={{ background:css.white, border:`1px solid ${css.border}`,
                  ...
                  <div style={{ padding:"16px 20px",
                    ...
                    <p style={{ fontSize:"13px", fontWeight:600, color:css.text }}>
                      Pagos pendientes
                    </p>
                    <button onClick={() => setActive("artist-accounts")}
                      style={{ fontSize:"12px", color:css.blue, background:"none",
                  ...
                  {summary.readyToPay.length === 0 ? (
                    ...
                    summary.readyToPay.map((a,i) => (
                      <div key={a.name} style={{ display:"flex", alignItems:"center",
                        ...
                        borderBottom: i<summary.readyToPay.length-1
                        ...
                        <div style={{ display:"flex", alignItems:"center", gap:"8px" }}>
                          <span style={{ fontSize:"13px", fontWeight:600, color:css.green }}>
                            {fmtUSD(a.amount)}
                          </span>
                          <span style={{ display:"inline-flex", alignItems:"center",
                            padding:"2px 8px", borderRadius:"9999px", fontSize:"11px",
                            fontWeight:500, color:css.green, background:css.greenBg,
                ...
                <div style={{ background:css.white, border:`1px solid ${css.border}`,
                  ...
                  <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr",
                    ...
                    {[
                      ...
                      { id:"tracks"          as Tab, label:"Tracks",       icon:"▶", desc:"Gestionar catálogo" },
                      { id:"press"           as Tab, label:"Prensa",       icon:"◧", desc:"Artículos y medios" },
                    ].map((item) => (
                      <button key={item.id} onClick={() => setActive(item.id)}
                        style={{ padding:"16px 20px", background:css.white,
                          border:"none", cursor:"pointer", textAlign:"left",
                        ...
                        <p style={{ fontSize:"13px", fontWeight:500,
                          color:css.text, marginBottom:"2px" }}>{item.label}</p>
