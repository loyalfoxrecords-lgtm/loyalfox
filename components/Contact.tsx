...
export default function Contact() {
  ...
  return (
    <section ref={ref} id="contact" style={{ background:"var(--black)",
      ...
      <div style={{ background:"#a8e63d", padding:"80px 56px",
        ...
        <motion.p
          ...
          style={{ fontFamily:"var(--font-mono)", fontSize:"13px",
            lineHeight:2, color:"rgba(8,8,8,0.6)",
            maxWidth:"400px" }}>
            ...
            {[
              ...
              <div key={item.label}
                ...
                <p style={{ fontFamily:"var(--font-mono)", fontSize:"9px",
                  ...
                  color:"rgba(168,230,61,0.6)", marginBottom:"8px" }}>
                  {item.label}
                </p>
          ...
          {status === "ok" ? (
            <motion.div
              ...
              <p style={{ fontFamily:"var(--font-mono)", fontSize:"11px",
                ...
                Te contestaremos en los próximos días. Gracias por tu interés en LoyalFox Records.
              </p>
            </motion.div>
          ) : (
            <form onSubmit={handleSubmit}
              ...
              {[
                ...
                <div key={field.id}>
                  <label style={{ fontFamily:"var(--font-mono)", fontSize:"9px",
                    letterSpacing:"3px", textTransform:"uppercase",
              ...
              <div>
                ...
                <textarea
                  placeholder="Cuéntanos sobre tu música, tu estilo, tus referencias..."
                  value={form.message}
                  ...
                  style={{ width:"100%", padding:"0 0 16px",
                    background:"transparent", border:"none",
                    borderBottom:"1px solid rgba(255,255,255,0.1)",
                    color:"#f0f0f0", fontSize:"15px", resize:"none",
                    fontFamily:"var(--font-mono)", outline:"none",
                    letterSpacing:"0.5px", transition:"border-color .2s" }}
                  onFocus={(e) => (e.currentTarget.style.borderBottomColor = "#a8e63d")}
                  onBlur={(e) => (e.currentTarget.style.borderBottomColor = "rgba(255,255,255,0.1)")} />
